...
var speedopts = {
  ...
  staticZones: [
    {strokeStyle: "#0F0", min: 0, max: 30}, // Green
   {strokeStyle: "yellow", min:30, max: 70}, // Green
   {strokeStyle: "orange", min: 70, max: 105}, // Yellow
   {strokeStyle: "#F00", min: 105, max: 140}, // Yellow
